...
set test_bench              "Merge_Sorter_Tree_Test_Bench_X04_W1_O0_S1"
set scenario_file           [file join $project_directory ".." ".." ".." "src" "test" "scenarios" "merge_sorter_tree" "test_x04_w1_o0_s1.snr" ]
#
# Create project
#
